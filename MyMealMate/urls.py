...
urlpatterns = [
    ...
    path('<slug:username_slug>/my_meals/<slug:meal_name_slug>/', views.meal, name='meal'),
    path('<slug:username_slug>/my_meals/<slug:meal_name_slug>/edit_meal/', views.edit_meal, name='edit_meal'),
